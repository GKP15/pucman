...
Pucman.Game.prototype = {
    ...
    preload: function() {
        ...
        this.load.image('start', 'resources/start.jpg');
    },
    ...
    createGUI: function() {
        this.textGUI = this.add.group();
        //this.bringToTop(textGUI);
        this.textGUI.classType = Phaser.Text;
        this.scoreString = 'Score : 42';
        this.textGUI.create(10, 10, this.scoreString, {
            font: '34px Arial',
            fill: '#000'
        });
        this.livesString = 'Lives : 3';
        this.textGUI.create(10, 50, this.livesString, {
            font: '34px Arial',
            fill: '#000'
        });
        this.searchString = 'Location: ______';
        this.textGUI.create(200, 30, this.searchString, {
            font: '34px Arial',
            fill: '#000'
        });
        this.startString = 'Start GAME';
        this.textGUI.create(100, 500, this.startString, {
            font: '52px Arial',
            fill: '#000'
        });
    },
